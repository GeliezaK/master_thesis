...
# List of filenames
filenames = [
    "data/processed/cloud_cover_2015-06-01_2020-05-05_Flesland_PT1H.csv",
    "data/processed/cloud_cover_2015-06-01_2025-05-15_Florida_PT3H.csv",
    "data/processed/cloud_cover_2020-05-05_2021-08-31_Flesland_PT10M.csv",
    "data/processed/cloud_cover_2021-09-01_2023-06-30_Flesland_PT10M.csv",
    "data/processed/cloud_cover_2023-07-01_2025-05-01_Flesland_PT10M.csv"
]
...
# Save to CSV
output_filename = "data/processed/cloud_cover_2015-06-01_2025-05-01_Florida_Flesland.csv"
merged_df.to_csv(output_filename, index=False)

# Read s2 data frame 
s2 = pd.read_csv('data/processed/s2_cloud_cover_cleaned.csv')
...
merged_all.to_csv("data/processed/cloud_cover_2015-06-01_2025-05-01_s2_Flesland_Florida_paired.csv", index=False)